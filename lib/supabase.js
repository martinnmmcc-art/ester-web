...
/* MODO DEMO
   true  = sitio de prueba: Google NO lo indexa y el canonical apunta a Vercel.
   false = sitio definitivo con el dominio de la clienta.
   Para pasar a produccion: en Vercel poner NEXT_PUBLIC_MODO_DEMO=false
   y NEXT_PUBLIC_SITE_URL=https://www.estercortezpropiedades.com.ar */
export const MODO_DEMO = process.env.NEXT_PUBLIC_MODO_DEMO !== "false";

export const SITE_URL = MODO_DEMO
  ? (process.env.NEXT_PUBLIC_SITE_URL || "https://ester-web.vercel.app")
  : (process.env.NEXT_PUBLIC_SITE_URL || "https://www.estercortezpropiedades.com.ar");
